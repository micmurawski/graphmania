...
import recursiveData from './data/recursive.js';
...
describe('Engine', () => {
    ...
    describe('instance', async () => {
        ...
        it('validation', async () => {
            assert.notStrictEqual(await engine.process(recursiveData), 'success', 'recursive data')
        });  
        ...
        it('process start node', async () => {
            ...
            assert.strictEqual(await engine.process(addNumbersData, correctId), 'success')
            // assert.strictEqual(await engine.process(addNumbersData, wrongId), 'error')
        });
    });
});